...
exports.run = (client, message, args) => {
  ...
  let welegendslog = guild.channels.find('name', 'welegends-log');
  if (!welegendslog) return message.reply('`welegends-log` kanalını bulamıyorum.');
  ...
  return guild.channels.get(welegendslog.id).sendEmbed(embed);
};
